package com.eras.UGD_PersistentData_Y_XXXX_100.ui.todolist;
...
import com.eras.UGD_PersistentData_Y_XXXX_100.Adapter.TodoAdapter;
    ...
    private void addTodo(){
        ...
        class AddTodo extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                DatabaseTodo.getInstance(getContext())
                        .getDatabase()
                        .todoDao()
                        .insertTodo(todo);
    ...
    private void getTodos() {
        class GetTodos extends AsyncTask<Void, Void, List<Todo>> {
            ...
            protected List<Todo> doInBackground(Void... voids) {
                List<Todo> todoList = DatabaseTodo.getInstance(getContext())
                        .getDatabase()
                        .todoDao()
                        .getAll();
                return todoList;
